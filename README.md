...
*Beagle* is a detector of interesting things in text. Its intended use is in stream search applications. Suppose you need to monitor a stream of text documents such as web crawl results, chat messages, or corporate documents in order to identify various keywords, phrases, and complex search queries of interest. With *Beagle* you can quickly be up and running with such a system, allowing you to focus on productively monitoring your documents.
